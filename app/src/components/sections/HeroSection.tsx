...
export function HeroSection() {
  return (
    <section id="hero" className="relative w-full hero-glow-bg border-b border-[rgba(255,255,255,0.08)] min-h-[640px] lg:min-h-screen lg:max-h-[860px] flex flex-col justify-center">
